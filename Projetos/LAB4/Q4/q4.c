...
int *ADC16Ptr;
int media[3];                             // vetor para guardar os valores de cada conversao
int canais[3] = {0b0010, 0b0101, 0b0111}; //pot, temp, ldr
float pot = 0;
float temp = 0;
float ldr = 0;
...
//Funcao para converter Float para Str dada uma determinada Precisao
//Exemplo:  nFloatToStr(3.14, 4, txt);       // Result: "3.1400"
...
void main()
{
  ...
  TRISEbits.TRISE8 = 1;
  IEC0bits.INT0IE = 1; //Talvez as coisas nao usem
  IFS0 = 0;
